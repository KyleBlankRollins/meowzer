...
previous: /docs/getting-started/introduction
...
**Note:** CDN imports are convenient for prototyping but not recommended for production. Use a bundler for better performance and caching.
...
See [Framework Integration](/docs/tutorials/framework-integration) for specific guides.
...
1. [**Quick Start**](/docs/getting-started/quick-start) - Create your first cat
2. [**First Cat Tutorial**](/docs/getting-started/first-cat) - Detailed walkthrough
3. [**Configuration**](/docs/guides/configuration) - Customize Meowzer behavior
