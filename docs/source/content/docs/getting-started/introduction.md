...
Learn more in [Architecture Concepts](/docs/concepts/architecture).
...
1. [**Installation**](/docs/getting-started/installation) - Install Meowzer in your project
2. [**Quick Start**](/docs/getting-started/quick-start) - Your first cat in 5 minutes
3. [**First Cat Tutorial**](/docs/getting-started/first-cat) - Detailed walkthrough
...
- [AI Behaviors](/docs/concepts/ai-behaviors) - How cats make decisions
