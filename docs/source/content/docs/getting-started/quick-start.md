...
previous: /docs/getting-started/installation
next: /docs/getting-started/first-cat
---

# Quick Start

Get a cat on your page in under 5 minutes. This guide assumes you've already [installed Meowzer](/docs/getting-started/installation).
...
1. **[First Cat Tutorial](/docs/getting-started/first-cat)** - Detailed walkthrough with more customization
2. **[Customization Guide](/docs/guides/customization)** - Complete appearance and personality options
3. **[Interactions Guide](/docs/guides/interactions)** - Food, toys, and more
4. **[API Reference](/docs/api/meowzer-sdk)** - Complete SDK documentation
